...
export default function Pagination() {
  ...
  return (
    <nav className="flex flex-row flex-nowrap justify-center items-center mt-3">
      <a onClick={() => control('previus') } className="flex w-10 h-10 mr-1 justify-center items-center rounded-full border border-gray-200 bg-white text-black hover:bg-blue-400" title="Previous Page">
      ...
      <a onClick={() => control('next') }  className="flex w-10 h-10 ml-1 justify-center items-center rounded-full border border-gray-200 bg-white text-black hover:bg-blue-400" title="Next Page">
